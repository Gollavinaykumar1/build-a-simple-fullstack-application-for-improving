// src/App.jsx — Generated by VIA for: build a simple fullstack application for improving the iq levels by playing the games and solving the puzzles
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build A Simple Fullstack Application For Improving The</span>
            </Link>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build A Simple Fullstack Application For Improving The</h1>
